...
## 挑戰
1. 受 LLM 幻覺等因素影響，精準診斷具挑戰性，現階段原型之診斷準確度仍有限。
2. 來自公開來源之醫師姓名、科別與語言等資料普遍禁止爬取，當前欠缺明確且合乎倫理的資料取得途徑。
